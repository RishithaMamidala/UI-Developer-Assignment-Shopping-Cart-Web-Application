...
**Header** shows the Kibo Store name and a cart icon with a badge. The badge count is the sum of all item quantities in the cart (so two units of one product count as two).
