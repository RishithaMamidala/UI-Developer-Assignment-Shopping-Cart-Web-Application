...
- [X] T002 Install state management deps: `npm install @reduxjs/toolkit react-redux redux-persist`
...
**Purpose**: Implement the core Redux store, RTK Query API, utility functions, and the custom filter/sort hook. These are shared across ALL user stories and MUST be complete before any story begins.
